    ...
    <view class="container">
        ...
        <view v-if="!hasLogin || empty===true" class="empty">
            ...
            <view v-if="hasLogin" class="empty-tips">
                空空如也
                <navigator v-if="hasLogin" class="navigator" url="../index/index" open-type="switchTab">随便逛逛></navigator>
            </view>
...
import uniNumberBox from '@/pages/components/uni-number-box.vue'
export default {
    components: {
        uniNumberBox
    },
